...
export const AD_UNITS = {
  bannerHome: IS_PRODUCTION
    ? (process.env.EXPO_PUBLIC_ADMOB_BANNER_HOME ?? TEST_IDS.banner)
    : TEST_IDS.banner,

  bannerStats: IS_PRODUCTION
    ? (process.env.EXPO_PUBLIC_ADMOB_BANNER_STATS ?? TEST_IDS.banner)
    : TEST_IDS.banner,
};
