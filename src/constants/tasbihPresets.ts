...
export const TASBIH_PRESETS: TasbihPreset[] = [
  ...
  },
  {
    ...
    defaultTarget: 100,
    virtue: 'Said by Ibrahim (peace be upon him) in the fire and by the Prophet ﷺ at Uhud — a refuge in hardship (Quran 3:173, Bukhari 4563).',
    virtueUr: 'آگ میں حضرت ابراہیم علیہ السلام اور اُحد میں نبی کریم ﷺ نے پڑھی — مشکل میں پناہ (القرآن ۳:۱۷۳، بخاری ۴۵۶۳)',
    virtueAr: 'قالها إبراهيم عليه السلام في النار والنبي ﷺ في أحد — ملجأ في الشدائد (آل عمران ١٧٣، البخاري ٤٥٦٣)',
  },
  {
    id: 'dua_yunus',
    ...
    defaultTarget: 40,
    virtue: 'The dua of Yunus (peace be upon him) from the belly of the whale — whoever calls with it, Allah answers (Quran 21:87, Tirmidhi 3505).',
    virtueUr: 'حضرت یونس علیہ السلام کی مچھلی کے پیٹ سے دعا — جو بھی اس سے دعا کرے اللہ قبول فرماتا ہے (القرآن ۲۱:۸۷، ترمذی ۳۵۰۵)',
    virtueAr: 'دعاء يونس عليه السلام من بطن الحوت — ما دعا بها أحد إلا استجاب الله له (الأنبياء ٨٧، الترمذي ٣٥٠٥)',
  },
  {
    id: 'rabbi_zidni_ilma',
